...
export const ContactsComponent = ({ mapIsOpen }) => {
    return (
        <address className={`${s.address}`}>
            ...
            <p>Приходите к нам по адресу: <strong className={`${s.addressStrong}`}> г. Саратов, Крымская, 5</strong></p>
            <DropDownList btnText='Развернуть карту'>
            ...
            <p>Звоните нам по телефону: <Link className={`${s.linkTel}`} href='tel:+79001658659'>8 (900) 165-86-59</Link></p>
